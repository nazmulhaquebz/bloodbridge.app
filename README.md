# 🩸 Blood Bridge — Official App Downloads

<div align="center">

<img src="https://img.shields.io/badge/Blood%20Bridge-v1.0.0-red?style=for-the-badge&logo=github" />
...
Since Blood Bridge is distributed directly (not through Play Store), you need to allow installation from unknown sources:

- Go to **Settings → Security** (or **Settings → Privacy**)
- Enable **"Install Unknown Apps"** or **"Unknown Sources"**
- On newer Android: When prompted, tap **"Allow from this source"**

**Step 3 — Install**
- Open your **Downloads** folder
- Tap on `bloodbridge.apk`
- Tap **Install**
- Once installed, tap **Open**

**Step 4 — First Launch**
- Register as a **Donor** or **Requester**
- Verify your email with the OTP sent to you
- Start using Blood Bridge! 🩸
...
- Open your **Downloads** folder
- Double-click `bloodbridge-setup.exe`
- If Windows SmartScreen appears, click **"More info"** → **"Run anyway"**
  - *(This appears because the app isn't yet code-signed with a Microsoft certificate)*

**Step 3 — Follow the Setup Wizard**
- Choose an installation folder (default is recommended)
- Click **Next → Next → Install**
- Click **Finish** to launch Blood Bridge

**Step 4 — First Launch**
- A Blood Bridge shortcut will appear on your Desktop
- Open it and register your account to begin

---

### 🍎 iOS Installation

> iOS app is currently under **App Store Review**. When approved, it will be listed on the Apple App Store and linked here.

**In the meantime**, use the web app on your iPhone/iPad browser:  
👉 [https://bloodbridge-two.vercel.app](https://bloodbridge-two.vercel.app)

**To add to Home Screen (iPhone):**
1. Open the link in **Safari**
2. Tap the **Share** icon (square with arrow)
3. Scroll down and tap **"Add to Home Screen"**
4. Tap **Add** — Blood Bridge will appear as an app icon!

---

### 🍏 macOS Installation

> macOS app is currently being packaged. When ready, a `.dmg` installer will be available here.

**In the meantime**, use the web app on your Mac browser:  
👉 [https://bloodbridge-two.vercel.app](https://bloodbridge-two.vercel.app)
...
**Q: Is Blood Bridge free?**  
A: Yes, completely free. No subscriptions, no ads, no hidden fees.

**Q: Is my data safe?**  
A: Yes. All messages are AES-256 encrypted end-to-end. We never sell your data.

**Q: Can I use it without installing the app?**  
A: Yes! Visit [bloodbridge-two.vercel.app](https://bloodbridge-two.vercel.app) from any browser.

**Q: Why isn't it on the Play Store / App Store?**  
...
Made with ❤️ for humanity · **One Drop, One Life**
